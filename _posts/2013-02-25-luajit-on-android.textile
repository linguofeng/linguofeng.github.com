...
<section>
  <div class="page-header">
    <h3>二、把生成的libluajit.a静态库文件与一些头文件拷贝到jni目录下</h3>
  </div>
  <p>本例子中使用的是ndk中的hello-jni工程</p>
<pre>
$ cp src/{libluajit.a,lua.h,lauxlib.h,lua.hpp,luaconf.h,luajit.h,lualib.h} ../android/jni
