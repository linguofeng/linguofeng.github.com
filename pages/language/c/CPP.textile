...
title: C++基础
description: 学习笔记
navigation: [1.HelloWorld, 2.变量与数据类型, 3.常量, 4.输入输出, 5.控制结构与函数, 6.高级数据类型, 7.动态内存, 8.数据结构, 9.其它数据类型, 10.面向对象, 11.C++高级概念]
---
...
<section id="10">
    ...
    <h3><small>10.1</small> 类(Class)</h3>
...
int main() {
    ...
    <h3><small>10.2</small> 友元与继承关系(Friendship and inheritance)</h3>
...
int main () {
    ...
    <h3><small>10.3</small> 多态性（Polymorphism）</h3>
    <p>基类的指针</p>
<pre class="prettyprint">
class CPolygon {
    protected:
...
<section id="11">
    ...
    <h3><small>11.1</small> 模板(Templates) <small>使得我们可以生成通用的函数</small></h3>
...
int main () {
    ...
    <h3><small>11.2</small> 命名空间(Namespaces) <small>将一组全局范围有效的类、对象或函数组织到一个名字下面。</small></h3>
...
int main () {
    ...
    <h3><small>11.3</small> 异常(Exceptions)</h3>
