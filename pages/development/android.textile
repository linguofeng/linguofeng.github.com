...
*(#302) *Frame Animation*
** "帧动画":android/AnimationDrawable.html - AnimationDrawable
...
pre. <application android:theme="@android:style/Theme.Black.NoTitleBar"
...
getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.main_title);// 自定义布局
